...
# Usage example
Main reason I created this script is so that I can build the newest mpv media player on my personal laptop then run it on my digital media player, which runs an extremely ancient GNU/Linux OS. So I'll use mpv as an example:
