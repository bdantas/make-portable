...
3. Copy the resulting tarball and wrapper script to the target GNU/Linux system (you can copy them into any directory on target system, just make sure the tarball and wrapper script are together in the same directory)
